  ...
  <nav class="navbar navbar-expand">
    ...
    <div class="right-topbar ml-auto">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown dropdown-lg">
          <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="javascript:;" data-toggle="dropdown">	<i class="bx bx-cart vertical-align-middle"></i>
